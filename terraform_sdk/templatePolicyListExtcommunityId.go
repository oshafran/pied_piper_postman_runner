...
var token string;
var (
	_ resource.Resource                = &templatePolicyListExtcommunityIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListExtcommunityIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListExtcommunityIdResource{}
)

func NewTemplatePolicyListExtcommunityIdResource() resource.Resource {
	return &templatePolicyListExtcommunityIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListExtcommunityIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListExtcommunityIdResourceModel struct{
...
func (r *templatePolicyListExtcommunityIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListExtcommunityIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_extcommunity_id"
}

func (d *templatePolicyListExtcommunityIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListExtcommunityIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListExtcommunityIdResourceModel

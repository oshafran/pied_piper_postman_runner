...
var token string;
var (
	_ resource.Resource                = &templatePolicyListExtcommunityResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListExtcommunityResource{}
	_ resource.ResourceWithImportState = &templatePolicyListExtcommunityResource{}
)

func NewTemplatePolicyListExtcommunityResource() resource.Resource {
	return &templatePolicyListExtcommunityResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListExtcommunityResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListExtcommunityResourceModel struct{
...
func (r *templatePolicyListExtcommunityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListExtcommunityResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_extcommunity"
}

func (d *templatePolicyListExtcommunityResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListExtcommunityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListExtcommunityResourceModel

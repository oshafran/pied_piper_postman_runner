...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTrunkgroupResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTrunkgroupResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTrunkgroupResource{}
)

func NewTemplatePolicyListTrunkgroupResource() resource.Resource {
	return &templatePolicyListTrunkgroupResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTrunkgroupResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTrunkgroupResourceModel struct{
...
func (r *templatePolicyListTrunkgroupResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTrunkgroupResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_trunkgroup"
}

func (d *templatePolicyListTrunkgroupResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTrunkgroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTrunkgroupResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionZonebasedfwIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionZonebasedfwIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionZonebasedfwIdResource{}
)

func NewTemplatePolicyDefinitionZonebasedfwIdResource() resource.Resource {
	return &templatePolicyDefinitionZonebasedfwIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionZonebasedfwIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionZonebasedfwIdResourceModel struct{
...
func (r *templatePolicyDefinitionZonebasedfwIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionZonebasedfwIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_zonebasedfw_id"
}

func (d *templatePolicyDefinitionZonebasedfwIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionZonebasedfwIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionZonebasedfwIdResourceModel

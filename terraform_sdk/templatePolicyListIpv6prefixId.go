...
var token string;
var (
	_ resource.Resource                = &templatePolicyListIpv6prefixIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListIpv6prefixIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListIpv6prefixIdResource{}
)

func NewTemplatePolicyListIpv6prefixIdResource() resource.Resource {
	return &templatePolicyListIpv6prefixIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListIpv6prefixIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListIpv6prefixIdResourceModel struct{
...
func (r *templatePolicyListIpv6prefixIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListIpv6prefixIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_ipv6prefix_id"
}

func (d *templatePolicyListIpv6prefixIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListIpv6prefixIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListIpv6prefixIdResourceModel

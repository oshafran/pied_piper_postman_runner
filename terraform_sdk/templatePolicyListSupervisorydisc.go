...
var token string;
var (
	_ resource.Resource                = &templatePolicyListSupervisorydiscResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListSupervisorydiscResource{}
	_ resource.ResourceWithImportState = &templatePolicyListSupervisorydiscResource{}
)

func NewTemplatePolicyListSupervisorydiscResource() resource.Resource {
	return &templatePolicyListSupervisorydiscResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListSupervisorydiscResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListSupervisorydiscResourceModel struct{
...
func (r *templatePolicyListSupervisorydiscResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListSupervisorydiscResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_supervisorydisc"
}

func (d *templatePolicyListSupervisorydiscResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListSupervisorydiscResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListSupervisorydiscResourceModel

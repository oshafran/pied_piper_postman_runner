...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionSslutdprofileIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionSslutdprofileIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionSslutdprofileIdResource{}
)

func NewTemplatePolicyDefinitionSslutdprofileIdResource() resource.Resource {
	return &templatePolicyDefinitionSslutdprofileIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionSslutdprofileIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionSslutdprofileIdResourceModel struct{
...
func (r *templatePolicyDefinitionSslutdprofileIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionSslutdprofileIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_sslutdprofile_id"
}

func (d *templatePolicyDefinitionSslutdprofileIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionSslutdprofileIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionSslutdprofileIdResourceModel

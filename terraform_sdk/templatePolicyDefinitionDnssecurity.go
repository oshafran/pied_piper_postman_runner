...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionDnssecurityResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionDnssecurityResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionDnssecurityResource{}
)

func NewTemplatePolicyDefinitionDnssecurityResource() resource.Resource {
	return &templatePolicyDefinitionDnssecurityResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionDnssecurityResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionDnssecurityResourceModel struct{
...
func (r *templatePolicyDefinitionDnssecurityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionDnssecurityResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_dnssecurity"
}

func (d *templatePolicyDefinitionDnssecurityResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionDnssecurityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionDnssecurityResourceModel

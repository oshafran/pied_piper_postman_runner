...
var token string;
var (
	_ resource.Resource                = &templatePolicyListAppprobeResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListAppprobeResource{}
	_ resource.ResourceWithImportState = &templatePolicyListAppprobeResource{}
)

func NewTemplatePolicyListAppprobeResource() resource.Resource {
	return &templatePolicyListAppprobeResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListAppprobeResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListAppprobeResourceModel struct{
...
func (r *templatePolicyListAppprobeResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListAppprobeResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_appprobe"
}

func (d *templatePolicyListAppprobeResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListAppprobeResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListAppprobeResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionIntrusionpreventionResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionIntrusionpreventionResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionIntrusionpreventionResource{}
)

func NewTemplatePolicyDefinitionIntrusionpreventionResource() resource.Resource {
	return &templatePolicyDefinitionIntrusionpreventionResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionIntrusionpreventionResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionIntrusionpreventionResourceModel struct{
...
func (r *templatePolicyDefinitionIntrusionpreventionResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionIntrusionpreventionResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_intrusionprevention"
}

func (d *templatePolicyDefinitionIntrusionpreventionResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionIntrusionpreventionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionIntrusionpreventionResourceModel

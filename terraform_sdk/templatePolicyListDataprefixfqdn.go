...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataprefixfqdnResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataprefixfqdnResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataprefixfqdnResource{}
)

func NewTemplatePolicyListDataprefixfqdnResource() resource.Resource {
	return &templatePolicyListDataprefixfqdnResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataprefixfqdnResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataprefixfqdnResourceModel struct{
...
func (r *templatePolicyListDataprefixfqdnResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataprefixfqdnResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataprefixfqdn"
}

func (d *templatePolicyListDataprefixfqdnResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataprefixfqdnResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataprefixfqdnResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListModempassthroughResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListModempassthroughResource{}
	_ resource.ResourceWithImportState = &templatePolicyListModempassthroughResource{}
)

func NewTemplatePolicyListModempassthroughResource() resource.Resource {
	return &templatePolicyListModempassthroughResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListModempassthroughResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListModempassthroughResourceModel struct{
...
func (r *templatePolicyListModempassthroughResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListModempassthroughResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_modempassthrough"
}

func (d *templatePolicyListModempassthroughResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListModempassthroughResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListModempassthroughResourceModel

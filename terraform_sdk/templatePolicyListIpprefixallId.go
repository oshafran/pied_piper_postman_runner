...
var token string;
var (
	_ resource.Resource                = &templatePolicyListIpprefixallIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListIpprefixallIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListIpprefixallIdResource{}
)

func NewTemplatePolicyListIpprefixallIdResource() resource.Resource {
	return &templatePolicyListIpprefixallIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListIpprefixallIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListIpprefixallIdResourceModel struct{
...
func (r *templatePolicyListIpprefixallIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListIpprefixallIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_ipprefixall_id"
}

func (d *templatePolicyListIpprefixallIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListIpprefixallIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListIpprefixallIdResourceModel

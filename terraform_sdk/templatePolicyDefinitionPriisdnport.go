...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionPriisdnportResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionPriisdnportResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionPriisdnportResource{}
)

func NewTemplatePolicyDefinitionPriisdnportResource() resource.Resource {
	return &templatePolicyDefinitionPriisdnportResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionPriisdnportResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionPriisdnportResourceModel struct{
...
func (r *templatePolicyDefinitionPriisdnportResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionPriisdnportResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_priisdnport"
}

func (d *templatePolicyDefinitionPriisdnportResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionPriisdnportResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionPriisdnportResourceModel

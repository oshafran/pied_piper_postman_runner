...
var token string;
var (
	_ resource.Resource                = &templatePolicyListPrefixIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListPrefixIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListPrefixIdResource{}
)

func NewTemplatePolicyListPrefixIdResource() resource.Resource {
	return &templatePolicyListPrefixIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListPrefixIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListPrefixIdResourceModel struct{
...
func (r *templatePolicyListPrefixIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListPrefixIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_prefix_id"
}

func (d *templatePolicyListPrefixIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListPrefixIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListPrefixIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListFqdnIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListFqdnIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListFqdnIdResource{}
)

func NewTemplatePolicyListFqdnIdResource() resource.Resource {
	return &templatePolicyListFqdnIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListFqdnIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListFqdnIdResourceModel struct{
...
func (r *templatePolicyListFqdnIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListFqdnIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_fqdn_id"
}

func (d *templatePolicyListFqdnIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListFqdnIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListFqdnIdResourceModel

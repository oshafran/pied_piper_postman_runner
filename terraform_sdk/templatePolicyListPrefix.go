...
var token string;
var (
	_ resource.Resource                = &templatePolicyListPrefixResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListPrefixResource{}
	_ resource.ResourceWithImportState = &templatePolicyListPrefixResource{}
)

func NewTemplatePolicyListPrefixResource() resource.Resource {
	return &templatePolicyListPrefixResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListPrefixResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListPrefixResourceModel struct{
...
func (r *templatePolicyListPrefixResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListPrefixResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_prefix"
}

func (d *templatePolicyListPrefixResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListPrefixResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListPrefixResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListLocalappIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListLocalappIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListLocalappIdResource{}
)

func NewTemplatePolicyListLocalappIdResource() resource.Resource {
	return &templatePolicyListLocalappIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListLocalappIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListLocalappIdResourceModel struct{
...
func (r *templatePolicyListLocalappIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListLocalappIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_localapp_id"
}

func (d *templatePolicyListLocalappIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListLocalappIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListLocalappIdResourceModel

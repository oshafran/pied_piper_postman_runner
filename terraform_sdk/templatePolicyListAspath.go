...
var token string;
var (
	_ resource.Resource                = &templatePolicyListAspathResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListAspathResource{}
	_ resource.ResourceWithImportState = &templatePolicyListAspathResource{}
)

func NewTemplatePolicyListAspathResource() resource.Resource {
	return &templatePolicyListAspathResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListAspathResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListAspathResourceModel struct{
...
func (r *templatePolicyListAspathResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListAspathResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_aspath"
}

func (d *templatePolicyListAspathResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListAspathResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListAspathResourceModel

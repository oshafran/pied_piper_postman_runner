...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionAdvancedinspectionprofileResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionAdvancedinspectionprofileResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionAdvancedinspectionprofileResource{}
)

func NewTemplatePolicyDefinitionAdvancedinspectionprofileResource() resource.Resource {
	return &templatePolicyDefinitionAdvancedinspectionprofileResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionAdvancedinspectionprofileResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionAdvancedinspectionprofileResourceModel struct{
...
func (r *templatePolicyDefinitionAdvancedinspectionprofileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionAdvancedinspectionprofileResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_advancedinspectionprofile"
}

func (d *templatePolicyDefinitionAdvancedinspectionprofileResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionAdvancedinspectionprofileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionAdvancedinspectionprofileResourceModel

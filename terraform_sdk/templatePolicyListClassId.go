...
var token string;
var (
	_ resource.Resource                = &templatePolicyListClassIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListClassIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListClassIdResource{}
)

func NewTemplatePolicyListClassIdResource() resource.Resource {
	return &templatePolicyListClassIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListClassIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListClassIdResourceModel struct{
...
func (r *templatePolicyListClassIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListClassIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_class_id"
}

func (d *templatePolicyListClassIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListClassIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListClassIdResourceModel

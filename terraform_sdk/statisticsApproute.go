...
var token string;
var (
	_ resource.Resource                = &statisticsApprouteResource{}
	_ resource.ResourceWithConfigure   = &statisticsApprouteResource{}
	_ resource.ResourceWithImportState = &statisticsApprouteResource{}
)

func NewStatisticsApprouteResource() resource.Resource {
	return &statisticsApprouteResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsApprouteResource struct {
	client *sdwanAPI.APIClient
}
type statisticsApprouteResourceModel struct{
...
func (r *statisticsApprouteResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsApprouteResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_approute"
}

func (d *statisticsApprouteResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsApprouteResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsApprouteResourceModel

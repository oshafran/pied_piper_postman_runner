...
var token string;
var (
	_ resource.Resource                = &templatePolicyListExpandedcommunityIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListExpandedcommunityIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListExpandedcommunityIdResource{}
)

func NewTemplatePolicyListExpandedcommunityIdResource() resource.Resource {
	return &templatePolicyListExpandedcommunityIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListExpandedcommunityIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListExpandedcommunityIdResourceModel struct{
...
func (r *templatePolicyListExpandedcommunityIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListExpandedcommunityIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_expandedcommunity_id"
}

func (d *templatePolicyListExpandedcommunityIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListExpandedcommunityIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListExpandedcommunityIdResourceModel

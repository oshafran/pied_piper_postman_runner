...
var token string;
var (
	_ resource.Resource                = &statisticsInterfaceResource{}
	_ resource.ResourceWithConfigure   = &statisticsInterfaceResource{}
	_ resource.ResourceWithImportState = &statisticsInterfaceResource{}
)

func NewStatisticsInterfaceResource() resource.Resource {
	return &statisticsInterfaceResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsInterfaceResource struct {
	client *sdwanAPI.APIClient
}
type statisticsInterfaceResourceModel struct{
...
func (r *statisticsInterfaceResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsInterfaceResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_interface"
}

func (d *statisticsInterfaceResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsInterfaceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsInterfaceResourceModel

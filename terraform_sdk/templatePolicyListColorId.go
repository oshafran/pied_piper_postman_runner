...
var token string;
var (
	_ resource.Resource                = &templatePolicyListColorIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListColorIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListColorIdResource{}
)

func NewTemplatePolicyListColorIdResource() resource.Resource {
	return &templatePolicyListColorIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListColorIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListColorIdResourceModel struct{
...
func (r *templatePolicyListColorIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListColorIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_color_id"
}

func (d *templatePolicyListColorIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListColorIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListColorIdResourceModel

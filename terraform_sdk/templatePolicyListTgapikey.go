...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTgapikeyResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTgapikeyResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTgapikeyResource{}
)

func NewTemplatePolicyListTgapikeyResource() resource.Resource {
	return &templatePolicyListTgapikeyResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTgapikeyResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTgapikeyResourceModel struct{
...
func (r *templatePolicyListTgapikeyResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTgapikeyResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_tgapikey"
}

func (d *templatePolicyListTgapikeyResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTgapikeyResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTgapikeyResourceModel

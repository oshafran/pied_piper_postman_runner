...
var token string;
var (
	_ resource.Resource                = &templatePolicyListGeolocationResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListGeolocationResource{}
	_ resource.ResourceWithImportState = &templatePolicyListGeolocationResource{}
)

func NewTemplatePolicyListGeolocationResource() resource.Resource {
	return &templatePolicyListGeolocationResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListGeolocationResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListGeolocationResourceModel struct{
...
func (r *templatePolicyListGeolocationResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListGeolocationResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_geolocation"
}

func (d *templatePolicyListGeolocationResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListGeolocationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListGeolocationResourceModel

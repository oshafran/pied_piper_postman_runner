...
var token string;
var (
	_ resource.Resource                = &templatePolicyListFaxprotocolIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListFaxprotocolIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListFaxprotocolIdResource{}
)

func NewTemplatePolicyListFaxprotocolIdResource() resource.Resource {
	return &templatePolicyListFaxprotocolIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListFaxprotocolIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListFaxprotocolIdResourceModel struct{
...
func (r *templatePolicyListFaxprotocolIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListFaxprotocolIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_faxprotocol_id"
}

func (d *templatePolicyListFaxprotocolIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListFaxprotocolIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListFaxprotocolIdResourceModel

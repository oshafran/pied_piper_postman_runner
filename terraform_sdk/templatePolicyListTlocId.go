...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTlocIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTlocIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTlocIdResource{}
)

func NewTemplatePolicyListTlocIdResource() resource.Resource {
	return &templatePolicyListTlocIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTlocIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTlocIdResourceModel struct{
...
func (r *templatePolicyListTlocIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTlocIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_tloc_id"
}

func (d *templatePolicyListTlocIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTlocIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTlocIdResourceModel

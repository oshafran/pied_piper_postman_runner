...
var token string;
var (
	_ resource.Resource                = &templatePolicyListZoneResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListZoneResource{}
	_ resource.ResourceWithImportState = &templatePolicyListZoneResource{}
)

func NewTemplatePolicyListZoneResource() resource.Resource {
	return &templatePolicyListZoneResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListZoneResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListZoneResourceModel struct{
...
func (r *templatePolicyListZoneResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListZoneResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_zone"
}

func (d *templatePolicyListZoneResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListZoneResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListZoneResourceModel

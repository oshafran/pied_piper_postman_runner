...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTranslationrulesIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTranslationrulesIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTranslationrulesIdResource{}
)

func NewTemplatePolicyListTranslationrulesIdResource() resource.Resource {
	return &templatePolicyListTranslationrulesIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTranslationrulesIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTranslationrulesIdResourceModel struct{
...
func (r *templatePolicyListTranslationrulesIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTranslationrulesIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_translationrules_id"
}

func (d *templatePolicyListTranslationrulesIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTranslationrulesIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTranslationrulesIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListAppIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListAppIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListAppIdResource{}
)

func NewTemplatePolicyListAppIdResource() resource.Resource {
	return &templatePolicyListAppIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListAppIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListAppIdResourceModel struct{
...
func (r *templatePolicyListAppIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListAppIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_app_id"
}

func (d *templatePolicyListAppIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListAppIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListAppIdResourceModel

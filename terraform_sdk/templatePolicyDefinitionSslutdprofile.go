...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionSslutdprofileResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionSslutdprofileResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionSslutdprofileResource{}
)

func NewTemplatePolicyDefinitionSslutdprofileResource() resource.Resource {
	return &templatePolicyDefinitionSslutdprofileResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionSslutdprofileResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionSslutdprofileResourceModel struct{
...
func (r *templatePolicyDefinitionSslutdprofileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionSslutdprofileResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_sslutdprofile"
}

func (d *templatePolicyDefinitionSslutdprofileResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionSslutdprofileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionSslutdprofileResourceModel

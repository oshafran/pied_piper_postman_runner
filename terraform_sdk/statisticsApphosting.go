...
var token string;
var (
	_ resource.Resource                = &statisticsApphostingResource{}
	_ resource.ResourceWithConfigure   = &statisticsApphostingResource{}
	_ resource.ResourceWithImportState = &statisticsApphostingResource{}
)

func NewStatisticsApphostingResource() resource.Resource {
	return &statisticsApphostingResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsApphostingResource struct {
	client *sdwanAPI.APIClient
}
type statisticsApphostingResourceModel struct{
...
func (r *statisticsApphostingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsApphostingResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_apphosting"
}

func (d *statisticsApphostingResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsApphostingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsApphostingResourceModel

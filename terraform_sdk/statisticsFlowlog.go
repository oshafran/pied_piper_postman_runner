...
var token string;
var (
	_ resource.Resource                = &statisticsFlowlogResource{}
	_ resource.ResourceWithConfigure   = &statisticsFlowlogResource{}
	_ resource.ResourceWithImportState = &statisticsFlowlogResource{}
)

func NewStatisticsFlowlogResource() resource.Resource {
	return &statisticsFlowlogResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsFlowlogResource struct {
	client *sdwanAPI.APIClient
}
type statisticsFlowlogResourceModel struct{
...
func (r *statisticsFlowlogResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsFlowlogResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_flowlog"
}

func (d *statisticsFlowlogResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsFlowlogResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsFlowlogResourceModel

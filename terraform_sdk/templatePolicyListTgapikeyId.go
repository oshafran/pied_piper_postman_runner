...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTgapikeyIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTgapikeyIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTgapikeyIdResource{}
)

func NewTemplatePolicyListTgapikeyIdResource() resource.Resource {
	return &templatePolicyListTgapikeyIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTgapikeyIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTgapikeyIdResourceModel struct{
...
func (r *templatePolicyListTgapikeyIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTgapikeyIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_tgapikey_id"
}

func (d *templatePolicyListTgapikeyIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTgapikeyIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTgapikeyIdResourceModel

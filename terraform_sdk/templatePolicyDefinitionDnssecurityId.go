...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionDnssecurityIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionDnssecurityIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionDnssecurityIdResource{}
)

func NewTemplatePolicyDefinitionDnssecurityIdResource() resource.Resource {
	return &templatePolicyDefinitionDnssecurityIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionDnssecurityIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionDnssecurityIdResourceModel struct{
...
func (r *templatePolicyDefinitionDnssecurityIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionDnssecurityIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_dnssecurity_id"
}

func (d *templatePolicyDefinitionDnssecurityIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionDnssecurityIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionDnssecurityIdResourceModel

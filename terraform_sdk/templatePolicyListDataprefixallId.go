...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataprefixallIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataprefixallIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataprefixallIdResource{}
)

func NewTemplatePolicyListDataprefixallIdResource() resource.Resource {
	return &templatePolicyListDataprefixallIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataprefixallIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataprefixallIdResourceModel struct{
...
func (r *templatePolicyListDataprefixallIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataprefixallIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataprefixall_id"
}

func (d *templatePolicyListDataprefixallIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataprefixallIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataprefixallIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListIpssignatureResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListIpssignatureResource{}
	_ resource.ResourceWithImportState = &templatePolicyListIpssignatureResource{}
)

func NewTemplatePolicyListIpssignatureResource() resource.Resource {
	return &templatePolicyListIpssignatureResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListIpssignatureResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListIpssignatureResourceModel struct{
...
func (r *templatePolicyListIpssignatureResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListIpssignatureResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_ipssignature"
}

func (d *templatePolicyListIpssignatureResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListIpssignatureResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListIpssignatureResourceModel

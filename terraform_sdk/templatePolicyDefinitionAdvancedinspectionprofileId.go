...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionAdvancedinspectionprofileIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionAdvancedinspectionprofileIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionAdvancedinspectionprofileIdResource{}
)

func NewTemplatePolicyDefinitionAdvancedinspectionprofileIdResource() resource.Resource {
	return &templatePolicyDefinitionAdvancedinspectionprofileIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionAdvancedinspectionprofileIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionAdvancedinspectionprofileIdResourceModel struct{
...
func (r *templatePolicyDefinitionAdvancedinspectionprofileIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionAdvancedinspectionprofileIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_advancedinspectionprofile_id"
}

func (d *templatePolicyDefinitionAdvancedinspectionprofileIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionAdvancedinspectionprofileIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionAdvancedinspectionprofileIdResourceModel

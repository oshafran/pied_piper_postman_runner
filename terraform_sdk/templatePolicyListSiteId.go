...
var token string;
var (
	_ resource.Resource                = &templatePolicyListSiteIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListSiteIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListSiteIdResource{}
)

func NewTemplatePolicyListSiteIdResource() resource.Resource {
	return &templatePolicyListSiteIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListSiteIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListSiteIdResourceModel struct{
...
func (r *templatePolicyListSiteIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListSiteIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_site_id"
}

func (d *templatePolicyListSiteIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListSiteIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListSiteIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataipv6prefixIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataipv6prefixIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataipv6prefixIdResource{}
)

func NewTemplatePolicyListDataipv6prefixIdResource() resource.Resource {
	return &templatePolicyListDataipv6prefixIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataipv6prefixIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataipv6prefixIdResourceModel struct{
...
func (r *templatePolicyListDataipv6prefixIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataipv6prefixIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataipv6prefix_id"
}

func (d *templatePolicyListDataipv6prefixIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataipv6prefixIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataipv6prefixIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionDataIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionDataIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionDataIdResource{}
)

func NewTemplatePolicyDefinitionDataIdResource() resource.Resource {
	return &templatePolicyDefinitionDataIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionDataIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionDataIdResourceModel struct{
...
func (r *templatePolicyDefinitionDataIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionDataIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_data_id"
}

func (d *templatePolicyDefinitionDataIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionDataIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionDataIdResourceModel

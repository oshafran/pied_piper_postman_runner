...
var token string;
var (
	_ resource.Resource                = &templateDeviceConfigAttachfeatureResource{}
	_ resource.ResourceWithConfigure   = &templateDeviceConfigAttachfeatureResource{}
	_ resource.ResourceWithImportState = &templateDeviceConfigAttachfeatureResource{}
)

func NewTemplateDeviceConfigAttachfeatureResource() resource.Resource {
	return &templateDeviceConfigAttachfeatureResource{}
}

// vpnSiteListsResource is the data source implementation.
type templateDeviceConfigAttachfeatureResource struct {
	client *sdwanAPI.APIClient
}
type templateDeviceConfigAttachfeatureResourceModel struct{
...
func (r *templateDeviceConfigAttachfeatureResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templateDeviceConfigAttachfeatureResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_device_config_attachfeature"
}

func (d *templateDeviceConfigAttachfeatureResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templateDeviceConfigAttachfeatureResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templateDeviceConfigAttachfeatureResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionDataResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionDataResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionDataResource{}
)

func NewTemplatePolicyDefinitionDataResource() resource.Resource {
	return &templatePolicyDefinitionDataResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionDataResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionDataResourceModel struct{
...
func (r *templatePolicyDefinitionDataResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionDataResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_data"
}

func (d *templatePolicyDefinitionDataResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionDataResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionDataResourceModel

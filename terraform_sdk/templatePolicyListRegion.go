...
var token string;
var (
	_ resource.Resource                = &templatePolicyListRegionResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListRegionResource{}
	_ resource.ResourceWithImportState = &templatePolicyListRegionResource{}
)

func NewTemplatePolicyListRegionResource() resource.Resource {
	return &templatePolicyListRegionResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListRegionResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListRegionResourceModel struct{
...
func (r *templatePolicyListRegionResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListRegionResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_region"
}

func (d *templatePolicyListRegionResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListRegionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListRegionResourceModel

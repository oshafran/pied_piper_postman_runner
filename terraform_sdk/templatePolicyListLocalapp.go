...
var token string;
var (
	_ resource.Resource                = &templatePolicyListLocalappResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListLocalappResource{}
	_ resource.ResourceWithImportState = &templatePolicyListLocalappResource{}
)

func NewTemplatePolicyListLocalappResource() resource.Resource {
	return &templatePolicyListLocalappResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListLocalappResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListLocalappResourceModel struct{
...
func (r *templatePolicyListLocalappResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListLocalappResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_localapp"
}

func (d *templatePolicyListLocalappResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListLocalappResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListLocalappResourceModel

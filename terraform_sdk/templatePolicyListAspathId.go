...
var token string;
var (
	_ resource.Resource                = &templatePolicyListAspathIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListAspathIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListAspathIdResource{}
)

func NewTemplatePolicyListAspathIdResource() resource.Resource {
	return &templatePolicyListAspathIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListAspathIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListAspathIdResourceModel struct{
...
func (r *templatePolicyListAspathIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListAspathIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_aspath_id"
}

func (d *templatePolicyListAspathIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListAspathIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListAspathIdResourceModel

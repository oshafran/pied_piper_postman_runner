...
var token string;
var (
	_ resource.Resource                = &templatePolicyListMediaprofileResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListMediaprofileResource{}
	_ resource.ResourceWithImportState = &templatePolicyListMediaprofileResource{}
)

func NewTemplatePolicyListMediaprofileResource() resource.Resource {
	return &templatePolicyListMediaprofileResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListMediaprofileResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListMediaprofileResourceModel struct{
...
func (r *templatePolicyListMediaprofileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListMediaprofileResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_mediaprofile"
}

func (d *templatePolicyListMediaprofileResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListMediaprofileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListMediaprofileResourceModel

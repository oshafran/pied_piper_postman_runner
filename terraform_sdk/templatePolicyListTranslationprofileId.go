...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTranslationprofileIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTranslationprofileIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTranslationprofileIdResource{}
)

func NewTemplatePolicyListTranslationprofileIdResource() resource.Resource {
	return &templatePolicyListTranslationprofileIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTranslationprofileIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTranslationprofileIdResourceModel struct{
...
func (r *templatePolicyListTranslationprofileIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTranslationprofileIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_translationprofile_id"
}

func (d *templatePolicyListTranslationprofileIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTranslationprofileIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTranslationprofileIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListProtocolnameIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListProtocolnameIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListProtocolnameIdResource{}
)

func NewTemplatePolicyListProtocolnameIdResource() resource.Resource {
	return &templatePolicyListProtocolnameIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListProtocolnameIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListProtocolnameIdResourceModel struct{
...
func (r *templatePolicyListProtocolnameIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListProtocolnameIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_protocolname_id"
}

func (d *templatePolicyListProtocolnameIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListProtocolnameIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListProtocolnameIdResourceModel

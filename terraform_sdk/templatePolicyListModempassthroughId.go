...
var token string;
var (
	_ resource.Resource                = &templatePolicyListModempassthroughIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListModempassthroughIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListModempassthroughIdResource{}
)

func NewTemplatePolicyListModempassthroughIdResource() resource.Resource {
	return &templatePolicyListModempassthroughIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListModempassthroughIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListModempassthroughIdResourceModel struct{
...
func (r *templatePolicyListModempassthroughIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListModempassthroughIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_modempassthrough_id"
}

func (d *templatePolicyListModempassthroughIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListModempassthroughIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListModempassthroughIdResourceModel

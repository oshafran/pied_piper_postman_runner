...
var token string;
var (
	_ resource.Resource                = &statisticsArtResource{}
	_ resource.ResourceWithConfigure   = &statisticsArtResource{}
	_ resource.ResourceWithImportState = &statisticsArtResource{}
)

func NewStatisticsArtResource() resource.Resource {
	return &statisticsArtResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsArtResource struct {
	client *sdwanAPI.APIClient
}
type statisticsArtResourceModel struct{
...
func (r *statisticsArtResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsArtResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_art"
}

func (d *statisticsArtResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsArtResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsArtResourceModel

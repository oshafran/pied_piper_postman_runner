...
var token string;
var (
	_ resource.Resource                = &v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource{}
	_ resource.ResourceWithConfigure   = &v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource{}
	_ resource.ResourceWithImportState = &v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource{}
)

func NewV1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource() resource.Resource {
	return &v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource struct {
	client *sdwanAPI.APIClient
}
type v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResourceModel struct{
...
func (r *v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_v1_feature_profile_mobility_global_profile_id_wifi_wifi_id"
}

func (d *v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state v1FeatureProfileMobilityGlobalProfileIdWifiWifiIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsDpiResource{}
	_ resource.ResourceWithConfigure   = &statisticsDpiResource{}
	_ resource.ResourceWithImportState = &statisticsDpiResource{}
)

func NewStatisticsDpiResource() resource.Resource {
	return &statisticsDpiResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsDpiResource struct {
	client *sdwanAPI.APIClient
}
type statisticsDpiResourceModel struct{
...
func (r *statisticsDpiResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsDpiResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_dpi"
}

func (d *statisticsDpiResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsDpiResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsDpiResourceModel

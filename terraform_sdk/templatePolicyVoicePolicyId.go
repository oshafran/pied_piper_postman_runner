...
var token string;
var (
	_ resource.Resource                = &templatePolicyVoicePolicyIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyVoicePolicyIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyVoicePolicyIdResource{}
)

func NewTemplatePolicyVoicePolicyIdResource() resource.Resource {
	return &templatePolicyVoicePolicyIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyVoicePolicyIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyVoicePolicyIdResourceModel struct{
...
func (r *templatePolicyVoicePolicyIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyVoicePolicyIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_voice_policy_id"
}

func (d *templatePolicyVoicePolicyIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyVoicePolicyIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyVoicePolicyIdResourceModel

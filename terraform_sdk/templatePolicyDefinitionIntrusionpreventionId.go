...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionIntrusionpreventionIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionIntrusionpreventionIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionIntrusionpreventionIdResource{}
)

func NewTemplatePolicyDefinitionIntrusionpreventionIdResource() resource.Resource {
	return &templatePolicyDefinitionIntrusionpreventionIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionIntrusionpreventionIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionIntrusionpreventionIdResourceModel struct{
...
func (r *templatePolicyDefinitionIntrusionpreventionIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionIntrusionpreventionIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_intrusionprevention_id"
}

func (d *templatePolicyDefinitionIntrusionpreventionIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionIntrusionpreventionIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionIntrusionpreventionIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListFaxprotocolResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListFaxprotocolResource{}
	_ resource.ResourceWithImportState = &templatePolicyListFaxprotocolResource{}
)

func NewTemplatePolicyListFaxprotocolResource() resource.Resource {
	return &templatePolicyListFaxprotocolResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListFaxprotocolResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListFaxprotocolResourceModel struct{
...
func (r *templatePolicyListFaxprotocolResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListFaxprotocolResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_faxprotocol"
}

func (d *templatePolicyListFaxprotocolResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListFaxprotocolResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListFaxprotocolResourceModel

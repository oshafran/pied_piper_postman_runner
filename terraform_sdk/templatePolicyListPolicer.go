...
var token string;
var (
	_ resource.Resource                = &templatePolicyListPolicerResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListPolicerResource{}
	_ resource.ResourceWithImportState = &templatePolicyListPolicerResource{}
)

func NewTemplatePolicyListPolicerResource() resource.Resource {
	return &templatePolicyListPolicerResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListPolicerResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListPolicerResourceModel struct{
...
func (r *templatePolicyListPolicerResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListPolicerResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_policer"
}

func (d *templatePolicyListPolicerResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListPolicerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListPolicerResourceModel

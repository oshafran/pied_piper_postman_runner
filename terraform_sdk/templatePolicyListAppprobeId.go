...
var token string;
var (
	_ resource.Resource                = &templatePolicyListAppprobeIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListAppprobeIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListAppprobeIdResource{}
)

func NewTemplatePolicyListAppprobeIdResource() resource.Resource {
	return &templatePolicyListAppprobeIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListAppprobeIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListAppprobeIdResourceModel struct{
...
func (r *templatePolicyListAppprobeIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListAppprobeIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_appprobe_id"
}

func (d *templatePolicyListAppprobeIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListAppprobeIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListAppprobeIdResourceModel

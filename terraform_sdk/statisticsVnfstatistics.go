...
var token string;
var (
	_ resource.Resource                = &statisticsVnfstatisticsResource{}
	_ resource.ResourceWithConfigure   = &statisticsVnfstatisticsResource{}
	_ resource.ResourceWithImportState = &statisticsVnfstatisticsResource{}
)

func NewStatisticsVnfstatisticsResource() resource.Resource {
	return &statisticsVnfstatisticsResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsVnfstatisticsResource struct {
	client *sdwanAPI.APIClient
}
type statisticsVnfstatisticsResourceModel struct{
...
func (r *statisticsVnfstatisticsResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsVnfstatisticsResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_vnfstatistics"
}

func (d *statisticsVnfstatisticsResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsVnfstatisticsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsVnfstatisticsResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionFxsdidportIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionFxsdidportIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionFxsdidportIdResource{}
)

func NewTemplatePolicyDefinitionFxsdidportIdResource() resource.Resource {
	return &templatePolicyDefinitionFxsdidportIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionFxsdidportIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionFxsdidportIdResourceModel struct{
...
func (r *templatePolicyDefinitionFxsdidportIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionFxsdidportIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_fxsdidport_id"
}

func (d *templatePolicyDefinitionFxsdidportIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionFxsdidportIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionFxsdidportIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionSsldecryptionIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionSsldecryptionIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionSsldecryptionIdResource{}
)

func NewTemplatePolicyDefinitionSsldecryptionIdResource() resource.Resource {
	return &templatePolicyDefinitionSsldecryptionIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionSsldecryptionIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionSsldecryptionIdResourceModel struct{
...
func (r *templatePolicyDefinitionSsldecryptionIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionSsldecryptionIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_ssldecryption_id"
}

func (d *templatePolicyDefinitionSsldecryptionIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionSsldecryptionIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionSsldecryptionIdResourceModel

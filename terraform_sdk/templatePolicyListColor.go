...
var token string;
var (
	_ resource.Resource                = &templatePolicyListColorResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListColorResource{}
	_ resource.ResourceWithImportState = &templatePolicyListColorResource{}
)

func NewTemplatePolicyListColorResource() resource.Resource {
	return &templatePolicyListColorResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListColorResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListColorResourceModel struct{
...
func (r *templatePolicyListColorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListColorResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_color"
}

func (d *templatePolicyListColorResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListColorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListColorResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListLocaldomainResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListLocaldomainResource{}
	_ resource.ResourceWithImportState = &templatePolicyListLocaldomainResource{}
)

func NewTemplatePolicyListLocaldomainResource() resource.Resource {
	return &templatePolicyListLocaldomainResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListLocaldomainResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListLocaldomainResourceModel struct{
...
func (r *templatePolicyListLocaldomainResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListLocaldomainResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_localdomain"
}

func (d *templatePolicyListLocaldomainResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListLocaldomainResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListLocaldomainResourceModel

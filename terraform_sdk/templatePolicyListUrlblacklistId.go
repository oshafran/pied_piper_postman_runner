...
var token string;
var (
	_ resource.Resource                = &templatePolicyListUrlblacklistIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListUrlblacklistIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListUrlblacklistIdResource{}
)

func NewTemplatePolicyListUrlblacklistIdResource() resource.Resource {
	return &templatePolicyListUrlblacklistIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListUrlblacklistIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListUrlblacklistIdResourceModel struct{
...
func (r *templatePolicyListUrlblacklistIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListUrlblacklistIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_urlblacklist_id"
}

func (d *templatePolicyListUrlblacklistIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListUrlblacklistIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListUrlblacklistIdResourceModel

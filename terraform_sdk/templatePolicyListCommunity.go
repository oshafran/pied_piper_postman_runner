...
var token string;
var (
	_ resource.Resource                = &templatePolicyListCommunityResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListCommunityResource{}
	_ resource.ResourceWithImportState = &templatePolicyListCommunityResource{}
)

func NewTemplatePolicyListCommunityResource() resource.Resource {
	return &templatePolicyListCommunityResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListCommunityResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListCommunityResourceModel struct{
...
func (r *templatePolicyListCommunityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListCommunityResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_community"
}

func (d *templatePolicyListCommunityResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListCommunityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListCommunityResourceModel

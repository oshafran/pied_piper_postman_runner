...
var token string;
var (
	_ resource.Resource                = &statisticsSystemResource{}
	_ resource.ResourceWithConfigure   = &statisticsSystemResource{}
	_ resource.ResourceWithImportState = &statisticsSystemResource{}
)

func NewStatisticsSystemResource() resource.Resource {
	return &statisticsSystemResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsSystemResource struct {
	client *sdwanAPI.APIClient
}
type statisticsSystemResourceModel struct{
...
func (r *statisticsSystemResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsSystemResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_system"
}

func (d *statisticsSystemResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsSystemResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsSystemResourceModel

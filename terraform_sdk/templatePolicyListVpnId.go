...
var token string;
var (
	_ resource.Resource                = &templatePolicyListVpnIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListVpnIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListVpnIdResource{}
)

func NewTemplatePolicyListVpnIdResource() resource.Resource {
	return &templatePolicyListVpnIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListVpnIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListVpnIdResourceModel struct{
...
func (r *templatePolicyListVpnIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListVpnIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_vpn_id"
}

func (d *templatePolicyListVpnIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListVpnIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListVpnIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListExpandedcommunityResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListExpandedcommunityResource{}
	_ resource.ResourceWithImportState = &templatePolicyListExpandedcommunityResource{}
)

func NewTemplatePolicyListExpandedcommunityResource() resource.Resource {
	return &templatePolicyListExpandedcommunityResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListExpandedcommunityResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListExpandedcommunityResourceModel struct{
...
func (r *templatePolicyListExpandedcommunityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListExpandedcommunityResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_expandedcommunity"
}

func (d *templatePolicyListExpandedcommunityResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListExpandedcommunityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListExpandedcommunityResourceModel

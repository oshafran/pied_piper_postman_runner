...
var token string;
var (
	_ resource.Resource                = &streamDeviceNwpiResource{}
	_ resource.ResourceWithConfigure   = &streamDeviceNwpiResource{}
	_ resource.ResourceWithImportState = &streamDeviceNwpiResource{}
)

func NewStreamDeviceNwpiResource() resource.Resource {
	return &streamDeviceNwpiResource{}
}

// vpnSiteListsResource is the data source implementation.
type streamDeviceNwpiResource struct {
	client *sdwanAPI.APIClient
}
type streamDeviceNwpiResourceModel struct{
...
func (r *streamDeviceNwpiResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *streamDeviceNwpiResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_stream_device_nwpi"
}

func (d *streamDeviceNwpiResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *streamDeviceNwpiResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state streamDeviceNwpiResourceModel

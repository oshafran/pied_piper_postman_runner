...
var token string;
var (
	_ resource.Resource                = &v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource{}
	_ resource.ResourceWithConfigure   = &v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource{}
	_ resource.ResourceWithImportState = &v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource{}
)

func NewV1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource() resource.Resource {
	return &v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource struct {
	client *sdwanAPI.APIClient
}
type v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResourceModel struct{
...
func (r *v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_v1_feature_profile_mobility_global_profile_id_vpn_vpn_id"
}

func (d *v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state v1FeatureProfileMobilityGlobalProfileIdVpnVpnIdResourceModel

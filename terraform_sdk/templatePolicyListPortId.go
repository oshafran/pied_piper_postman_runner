...
var token string;
var (
	_ resource.Resource                = &templatePolicyListPortIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListPortIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListPortIdResource{}
)

func NewTemplatePolicyListPortIdResource() resource.Resource {
	return &templatePolicyListPortIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListPortIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListPortIdResourceModel struct{
...
func (r *templatePolicyListPortIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListPortIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_port_id"
}

func (d *templatePolicyListPortIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListPortIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListPortIdResourceModel

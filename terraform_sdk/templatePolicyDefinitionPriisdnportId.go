...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionPriisdnportIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionPriisdnportIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionPriisdnportIdResource{}
)

func NewTemplatePolicyDefinitionPriisdnportIdResource() resource.Resource {
	return &templatePolicyDefinitionPriisdnportIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionPriisdnportIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionPriisdnportIdResourceModel struct{
...
func (r *templatePolicyDefinitionPriisdnportIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionPriisdnportIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_priisdnport_id"
}

func (d *templatePolicyDefinitionPriisdnportIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionPriisdnportIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionPriisdnportIdResourceModel

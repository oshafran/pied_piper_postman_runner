...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionSrstphoneprofileResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionSrstphoneprofileResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionSrstphoneprofileResource{}
)

func NewTemplatePolicyDefinitionSrstphoneprofileResource() resource.Resource {
	return &templatePolicyDefinitionSrstphoneprofileResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionSrstphoneprofileResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionSrstphoneprofileResourceModel struct{
...
func (r *templatePolicyDefinitionSrstphoneprofileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionSrstphoneprofileResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_srstphoneprofile"
}

func (d *templatePolicyDefinitionSrstphoneprofileResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionSrstphoneprofileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionSrstphoneprofileResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListIpssignatureIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListIpssignatureIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListIpssignatureIdResource{}
)

func NewTemplatePolicyListIpssignatureIdResource() resource.Resource {
	return &templatePolicyListIpssignatureIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListIpssignatureIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListIpssignatureIdResourceModel struct{
...
func (r *templatePolicyListIpssignatureIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListIpssignatureIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_ipssignature_id"
}

func (d *templatePolicyListIpssignatureIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListIpssignatureIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListIpssignatureIdResourceModel

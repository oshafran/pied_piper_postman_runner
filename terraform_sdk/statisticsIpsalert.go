...
var token string;
var (
	_ resource.Resource                = &statisticsIpsalertResource{}
	_ resource.ResourceWithConfigure   = &statisticsIpsalertResource{}
	_ resource.ResourceWithImportState = &statisticsIpsalertResource{}
)

func NewStatisticsIpsalertResource() resource.Resource {
	return &statisticsIpsalertResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsIpsalertResource struct {
	client *sdwanAPI.APIClient
}
type statisticsIpsalertResourceModel struct{
...
func (r *statisticsIpsalertResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsIpsalertResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_ipsalert"
}

func (d *statisticsIpsalertResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsIpsalertResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsIpsalertResourceModel

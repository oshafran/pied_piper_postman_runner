...
var token string;
var (
	_ resource.Resource                = &statisticsQosResource{}
	_ resource.ResourceWithConfigure   = &statisticsQosResource{}
	_ resource.ResourceWithImportState = &statisticsQosResource{}
)

func NewStatisticsQosResource() resource.Resource {
	return &statisticsQosResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsQosResource struct {
	client *sdwanAPI.APIClient
}
type statisticsQosResourceModel struct{
...
func (r *statisticsQosResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsQosResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_qos"
}

func (d *statisticsQosResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsQosResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsQosResourceModel

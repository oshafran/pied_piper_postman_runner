...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionDialpeerResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionDialpeerResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionDialpeerResource{}
)

func NewTemplatePolicyDefinitionDialpeerResource() resource.Resource {
	return &templatePolicyDefinitionDialpeerResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionDialpeerResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionDialpeerResourceModel struct{
...
func (r *templatePolicyDefinitionDialpeerResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionDialpeerResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_dialpeer"
}

func (d *templatePolicyDefinitionDialpeerResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionDialpeerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionDialpeerResourceModel

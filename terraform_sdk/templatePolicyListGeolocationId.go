...
var token string;
var (
	_ resource.Resource                = &templatePolicyListGeolocationIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListGeolocationIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListGeolocationIdResource{}
)

func NewTemplatePolicyListGeolocationIdResource() resource.Resource {
	return &templatePolicyListGeolocationIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListGeolocationIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListGeolocationIdResourceModel struct{
...
func (r *templatePolicyListGeolocationIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListGeolocationIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_geolocation_id"
}

func (d *templatePolicyListGeolocationIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListGeolocationIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListGeolocationIdResourceModel

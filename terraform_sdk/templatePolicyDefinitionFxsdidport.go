...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionFxsdidportResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionFxsdidportResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionFxsdidportResource{}
)

func NewTemplatePolicyDefinitionFxsdidportResource() resource.Resource {
	return &templatePolicyDefinitionFxsdidportResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionFxsdidportResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionFxsdidportResourceModel struct{
...
func (r *templatePolicyDefinitionFxsdidportResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionFxsdidportResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_fxsdidport"
}

func (d *templatePolicyDefinitionFxsdidportResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionFxsdidportResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionFxsdidportResourceModel

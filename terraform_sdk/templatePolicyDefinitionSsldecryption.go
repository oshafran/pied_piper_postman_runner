...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionSsldecryptionResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionSsldecryptionResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionSsldecryptionResource{}
)

func NewTemplatePolicyDefinitionSsldecryptionResource() resource.Resource {
	return &templatePolicyDefinitionSsldecryptionResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionSsldecryptionResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionSsldecryptionResourceModel struct{
...
func (r *templatePolicyDefinitionSsldecryptionResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionSsldecryptionResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_ssldecryption"
}

func (d *templatePolicyDefinitionSsldecryptionResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionSsldecryptionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionSsldecryptionResourceModel

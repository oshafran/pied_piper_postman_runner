...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionFxoportIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionFxoportIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionFxoportIdResource{}
)

func NewTemplatePolicyDefinitionFxoportIdResource() resource.Resource {
	return &templatePolicyDefinitionFxoportIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionFxoportIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionFxoportIdResourceModel struct{
...
func (r *templatePolicyDefinitionFxoportIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionFxoportIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_fxoport_id"
}

func (d *templatePolicyDefinitionFxoportIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionFxoportIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionFxoportIdResourceModel

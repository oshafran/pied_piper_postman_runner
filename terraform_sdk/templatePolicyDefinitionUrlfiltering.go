...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionUrlfilteringResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionUrlfilteringResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionUrlfilteringResource{}
)

func NewTemplatePolicyDefinitionUrlfilteringResource() resource.Resource {
	return &templatePolicyDefinitionUrlfilteringResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionUrlfilteringResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionUrlfilteringResourceModel struct{
...
func (r *templatePolicyDefinitionUrlfilteringResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionUrlfilteringResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_urlfiltering"
}

func (d *templatePolicyDefinitionUrlfilteringResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionUrlfilteringResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionUrlfilteringResourceModel

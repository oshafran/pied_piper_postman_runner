...
var token string;
var (
	_ resource.Resource                = &templatePolicyListIpv6prefixResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListIpv6prefixResource{}
	_ resource.ResourceWithImportState = &templatePolicyListIpv6prefixResource{}
)

func NewTemplatePolicyListIpv6prefixResource() resource.Resource {
	return &templatePolicyListIpv6prefixResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListIpv6prefixResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListIpv6prefixResourceModel struct{
...
func (r *templatePolicyListIpv6prefixResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListIpv6prefixResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_ipv6prefix"
}

func (d *templatePolicyListIpv6prefixResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListIpv6prefixResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListIpv6prefixResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsFwallResource{}
	_ resource.ResourceWithConfigure   = &statisticsFwallResource{}
	_ resource.ResourceWithImportState = &statisticsFwallResource{}
)

func NewStatisticsFwallResource() resource.Resource {
	return &statisticsFwallResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsFwallResource struct {
	client *sdwanAPI.APIClient
}
type statisticsFwallResourceModel struct{
...
func (r *statisticsFwallResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsFwallResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_fwall"
}

func (d *statisticsFwallResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsFwallResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsFwallResourceModel

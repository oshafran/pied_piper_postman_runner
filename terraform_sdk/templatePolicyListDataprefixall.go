...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataprefixallResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataprefixallResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataprefixallResource{}
)

func NewTemplatePolicyListDataprefixallResource() resource.Resource {
	return &templatePolicyListDataprefixallResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataprefixallResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataprefixallResourceModel struct{
...
func (r *templatePolicyListDataprefixallResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataprefixallResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataprefixall"
}

func (d *templatePolicyListDataprefixallResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataprefixallResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataprefixallResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListUmbrelladataResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListUmbrelladataResource{}
	_ resource.ResourceWithImportState = &templatePolicyListUmbrelladataResource{}
)

func NewTemplatePolicyListUmbrelladataResource() resource.Resource {
	return &templatePolicyListUmbrelladataResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListUmbrelladataResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListUmbrelladataResourceModel struct{
...
func (r *templatePolicyListUmbrelladataResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListUmbrelladataResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_umbrelladata"
}

func (d *templatePolicyListUmbrelladataResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListUmbrelladataResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListUmbrelladataResourceModel

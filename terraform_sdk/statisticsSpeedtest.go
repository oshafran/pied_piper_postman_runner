...
var token string;
var (
	_ resource.Resource                = &statisticsSpeedtestResource{}
	_ resource.ResourceWithConfigure   = &statisticsSpeedtestResource{}
	_ resource.ResourceWithImportState = &statisticsSpeedtestResource{}
)

func NewStatisticsSpeedtestResource() resource.Resource {
	return &statisticsSpeedtestResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsSpeedtestResource struct {
	client *sdwanAPI.APIClient
}
type statisticsSpeedtestResourceModel struct{
...
func (r *statisticsSpeedtestResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsSpeedtestResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_speedtest"
}

func (d *statisticsSpeedtestResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsSpeedtestResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsSpeedtestResourceModel

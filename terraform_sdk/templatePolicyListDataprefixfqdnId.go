...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataprefixfqdnIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataprefixfqdnIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataprefixfqdnIdResource{}
)

func NewTemplatePolicyListDataprefixfqdnIdResource() resource.Resource {
	return &templatePolicyListDataprefixfqdnIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataprefixfqdnIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataprefixfqdnIdResourceModel struct{
...
func (r *templatePolicyListDataprefixfqdnIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataprefixfqdnIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataprefixfqdn_id"
}

func (d *templatePolicyListDataprefixfqdnIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataprefixfqdnIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataprefixfqdnIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsCloudxResource{}
	_ resource.ResourceWithConfigure   = &statisticsCloudxResource{}
	_ resource.ResourceWithImportState = &statisticsCloudxResource{}
)

func NewStatisticsCloudxResource() resource.Resource {
	return &statisticsCloudxResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsCloudxResource struct {
	client *sdwanAPI.APIClient
}
type statisticsCloudxResourceModel struct{
...
func (r *statisticsCloudxResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsCloudxResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_cloudx"
}

func (d *statisticsCloudxResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsCloudxResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsCloudxResourceModel

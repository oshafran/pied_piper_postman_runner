...
var token string;
var (
	_ resource.Resource                = &v1FeatureProfileMobilityGlobalProfileIdEthernetResource{}
	_ resource.ResourceWithConfigure   = &v1FeatureProfileMobilityGlobalProfileIdEthernetResource{}
	_ resource.ResourceWithImportState = &v1FeatureProfileMobilityGlobalProfileIdEthernetResource{}
)

func NewV1FeatureProfileMobilityGlobalProfileIdEthernetResource() resource.Resource {
	return &v1FeatureProfileMobilityGlobalProfileIdEthernetResource{}
}

// vpnSiteListsResource is the data source implementation.
type v1FeatureProfileMobilityGlobalProfileIdEthernetResource struct {
	client *sdwanAPI.APIClient
}
type v1FeatureProfileMobilityGlobalProfileIdEthernetResourceModel struct{
...
func (r *v1FeatureProfileMobilityGlobalProfileIdEthernetResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *v1FeatureProfileMobilityGlobalProfileIdEthernetResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_v1_feature_profile_mobility_global_profile_id_ethernet"
}

func (d *v1FeatureProfileMobilityGlobalProfileIdEthernetResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *v1FeatureProfileMobilityGlobalProfileIdEthernetResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state v1FeatureProfileMobilityGlobalProfileIdEthernetResourceModel
  ...
  EthernetId:              types.String{Value: vpnSiteList["key"].(string)}, 
}

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListAppResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListAppResource{}
	_ resource.ResourceWithImportState = &templatePolicyListAppResource{}
)

func NewTemplatePolicyListAppResource() resource.Resource {
	return &templatePolicyListAppResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListAppResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListAppResourceModel struct{
...
func (r *templatePolicyListAppResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListAppResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_app"
}

func (d *templatePolicyListAppResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListAppResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListAppResourceModel

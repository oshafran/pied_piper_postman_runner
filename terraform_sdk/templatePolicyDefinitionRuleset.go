...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionRulesetResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionRulesetResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionRulesetResource{}
)

func NewTemplatePolicyDefinitionRulesetResource() resource.Resource {
	return &templatePolicyDefinitionRulesetResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionRulesetResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionRulesetResourceModel struct{
...
func (r *templatePolicyDefinitionRulesetResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionRulesetResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_ruleset"
}

func (d *templatePolicyDefinitionRulesetResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionRulesetResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionRulesetResourceModel

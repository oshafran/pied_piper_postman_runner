...
var token string;
var (
	_ resource.Resource                = &templatePolicyListSlaIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListSlaIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListSlaIdResource{}
)

func NewTemplatePolicyListSlaIdResource() resource.Resource {
	return &templatePolicyListSlaIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListSlaIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListSlaIdResourceModel struct{
...
func (r *templatePolicyListSlaIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListSlaIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_sla_id"
}

func (d *templatePolicyListSlaIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListSlaIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListSlaIdResourceModel

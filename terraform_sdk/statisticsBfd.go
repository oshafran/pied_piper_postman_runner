...
var token string;
var (
	_ resource.Resource                = &statisticsBfdResource{}
	_ resource.ResourceWithConfigure   = &statisticsBfdResource{}
	_ resource.ResourceWithImportState = &statisticsBfdResource{}
)

func NewStatisticsBfdResource() resource.Resource {
	return &statisticsBfdResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsBfdResource struct {
	client *sdwanAPI.APIClient
}
type statisticsBfdResourceModel struct{
...
func (r *statisticsBfdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsBfdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_bfd"
}

func (d *statisticsBfdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsBfdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsBfdResourceModel

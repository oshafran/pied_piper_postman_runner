...
var token string;
var (
	_ resource.Resource                = &templatePolicyListZoneIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListZoneIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListZoneIdResource{}
)

func NewTemplatePolicyListZoneIdResource() resource.Resource {
	return &templatePolicyListZoneIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListZoneIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListZoneIdResourceModel struct{
...
func (r *templatePolicyListZoneIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListZoneIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_zone_id"
}

func (d *templatePolicyListZoneIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListZoneIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListZoneIdResourceModel

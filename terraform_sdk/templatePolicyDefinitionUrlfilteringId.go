...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionUrlfilteringIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionUrlfilteringIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionUrlfilteringIdResource{}
)

func NewTemplatePolicyDefinitionUrlfilteringIdResource() resource.Resource {
	return &templatePolicyDefinitionUrlfilteringIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionUrlfilteringIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionUrlfilteringIdResourceModel struct{
...
func (r *templatePolicyDefinitionUrlfilteringIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionUrlfilteringIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_urlfiltering_id"
}

func (d *templatePolicyDefinitionUrlfilteringIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionUrlfilteringIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionUrlfilteringIdResourceModel

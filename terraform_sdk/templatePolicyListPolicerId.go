...
var token string;
var (
	_ resource.Resource                = &templatePolicyListPolicerIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListPolicerIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListPolicerIdResource{}
)

func NewTemplatePolicyListPolicerIdResource() resource.Resource {
	return &templatePolicyListPolicerIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListPolicerIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListPolicerIdResourceModel struct{
...
func (r *templatePolicyListPolicerIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListPolicerIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_policer_id"
}

func (d *templatePolicyListPolicerIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListPolicerIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListPolicerIdResourceModel

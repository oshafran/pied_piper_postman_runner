...
var token string;
var (
	_ resource.Resource                = &templatePolicyListSlaResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListSlaResource{}
	_ resource.ResourceWithImportState = &templatePolicyListSlaResource{}
)

func NewTemplatePolicyListSlaResource() resource.Resource {
	return &templatePolicyListSlaResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListSlaResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListSlaResourceModel struct{
...
func (r *templatePolicyListSlaResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListSlaResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_sla"
}

func (d *templatePolicyListSlaResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListSlaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListSlaResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsBridgemacResource{}
	_ resource.ResourceWithConfigure   = &statisticsBridgemacResource{}
	_ resource.ResourceWithImportState = &statisticsBridgemacResource{}
)

func NewStatisticsBridgemacResource() resource.Resource {
	return &statisticsBridgemacResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsBridgemacResource struct {
	client *sdwanAPI.APIClient
}
type statisticsBridgemacResourceModel struct{
...
func (r *statisticsBridgemacResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsBridgemacResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_bridgemac"
}

func (d *statisticsBridgemacResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsBridgemacResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsBridgemacResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsDeviceResource{}
	_ resource.ResourceWithConfigure   = &statisticsDeviceResource{}
	_ resource.ResourceWithImportState = &statisticsDeviceResource{}
)

func NewStatisticsDeviceResource() resource.Resource {
	return &statisticsDeviceResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsDeviceResource struct {
	client *sdwanAPI.APIClient
}
type statisticsDeviceResourceModel struct{
...
func (r *statisticsDeviceResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsDeviceResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_device"
}

func (d *statisticsDeviceResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsDeviceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsDeviceResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataprefixResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataprefixResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataprefixResource{}
)

func NewTemplatePolicyListDataprefixResource() resource.Resource {
	return &templatePolicyListDataprefixResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataprefixResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataprefixResourceModel struct{
...
func (r *templatePolicyListDataprefixResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataprefixResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataprefix"
}

func (d *templatePolicyListDataprefixResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataprefixResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataprefixResourceModel

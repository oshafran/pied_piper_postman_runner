...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTlocResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTlocResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTlocResource{}
)

func NewTemplatePolicyListTlocResource() resource.Resource {
	return &templatePolicyListTlocResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTlocResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTlocResourceModel struct{
...
func (r *templatePolicyListTlocResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTlocResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_tloc"
}

func (d *templatePolicyListTlocResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTlocResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTlocResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataipv6prefixResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataipv6prefixResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataipv6prefixResource{}
)

func NewTemplatePolicyListDataipv6prefixResource() resource.Resource {
	return &templatePolicyListDataipv6prefixResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataipv6prefixResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataipv6prefixResourceModel struct{
...
func (r *templatePolicyListDataipv6prefixResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataipv6prefixResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataipv6prefix"
}

func (d *templatePolicyListDataipv6prefixResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataipv6prefixResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataipv6prefixResourceModel

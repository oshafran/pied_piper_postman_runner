...
var token string;
var (
	_ resource.Resource                = &templatePolicyListUmbrelladataIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListUmbrelladataIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListUmbrelladataIdResource{}
)

func NewTemplatePolicyListUmbrelladataIdResource() resource.Resource {
	return &templatePolicyListUmbrelladataIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListUmbrelladataIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListUmbrelladataIdResourceModel struct{
...
func (r *templatePolicyListUmbrelladataIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListUmbrelladataIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_umbrelladata_id"
}

func (d *templatePolicyListUmbrelladataIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListUmbrelladataIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListUmbrelladataIdResourceModel

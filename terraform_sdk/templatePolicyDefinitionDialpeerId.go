...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionDialpeerIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionDialpeerIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionDialpeerIdResource{}
)

func NewTemplatePolicyDefinitionDialpeerIdResource() resource.Resource {
	return &templatePolicyDefinitionDialpeerIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionDialpeerIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionDialpeerIdResourceModel struct{
...
func (r *templatePolicyDefinitionDialpeerIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionDialpeerIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_dialpeer_id"
}

func (d *templatePolicyDefinitionDialpeerIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionDialpeerIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionDialpeerIdResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsWlanclientinfoResource{}
	_ resource.ResourceWithConfigure   = &statisticsWlanclientinfoResource{}
	_ resource.ResourceWithImportState = &statisticsWlanclientinfoResource{}
)

func NewStatisticsWlanclientinfoResource() resource.Resource {
	return &statisticsWlanclientinfoResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsWlanclientinfoResource struct {
	client *sdwanAPI.APIClient
}
type statisticsWlanclientinfoResourceModel struct{
...
func (r *statisticsWlanclientinfoResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsWlanclientinfoResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_wlanclientinfo"
}

func (d *statisticsWlanclientinfoResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsWlanclientinfoResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsWlanclientinfoResourceModel

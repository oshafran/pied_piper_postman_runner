...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionSecuritygroupIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionSecuritygroupIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionSecuritygroupIdResource{}
)

func NewTemplatePolicyDefinitionSecuritygroupIdResource() resource.Resource {
	return &templatePolicyDefinitionSecuritygroupIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionSecuritygroupIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionSecuritygroupIdResourceModel struct{
...
func (r *templatePolicyDefinitionSecuritygroupIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionSecuritygroupIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_securitygroup_id"
}

func (d *templatePolicyDefinitionSecuritygroupIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionSecuritygroupIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionSecuritygroupIdResourceModel

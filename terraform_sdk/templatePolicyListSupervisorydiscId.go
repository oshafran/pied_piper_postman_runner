...
var token string;
var (
	_ resource.Resource                = &templatePolicyListSupervisorydiscIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListSupervisorydiscIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListSupervisorydiscIdResource{}
)

func NewTemplatePolicyListSupervisorydiscIdResource() resource.Resource {
	return &templatePolicyListSupervisorydiscIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListSupervisorydiscIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListSupervisorydiscIdResourceModel struct{
...
func (r *templatePolicyListSupervisorydiscIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListSupervisorydiscIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_supervisorydisc_id"
}

func (d *templatePolicyListSupervisorydiscIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListSupervisorydiscIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListSupervisorydiscIdResourceModel

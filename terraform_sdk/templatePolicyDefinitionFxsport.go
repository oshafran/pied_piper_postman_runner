...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionFxsportResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionFxsportResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionFxsportResource{}
)

func NewTemplatePolicyDefinitionFxsportResource() resource.Resource {
	return &templatePolicyDefinitionFxsportResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionFxsportResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionFxsportResourceModel struct{
...
func (r *templatePolicyDefinitionFxsportResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionFxsportResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_fxsport"
}

func (d *templatePolicyDefinitionFxsportResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionFxsportResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionFxsportResourceModel

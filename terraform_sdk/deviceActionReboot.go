...
var token string;
var (
	_ resource.Resource                = &deviceActionRebootResource{}
	_ resource.ResourceWithConfigure   = &deviceActionRebootResource{}
	_ resource.ResourceWithImportState = &deviceActionRebootResource{}
)

func NewDeviceActionRebootResource() resource.Resource {
	return &deviceActionRebootResource{}
}

// vpnSiteListsResource is the data source implementation.
type deviceActionRebootResource struct {
	client *sdwanAPI.APIClient
}
type deviceActionRebootResourceModel struct{
...
func (r *deviceActionRebootResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *deviceActionRebootResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_device_action_reboot"
}

func (d *deviceActionRebootResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *deviceActionRebootResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state deviceActionRebootResourceModel

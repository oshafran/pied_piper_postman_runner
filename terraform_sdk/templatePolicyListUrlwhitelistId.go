...
var token string;
var (
	_ resource.Resource                = &templatePolicyListUrlwhitelistIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListUrlwhitelistIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListUrlwhitelistIdResource{}
)

func NewTemplatePolicyListUrlwhitelistIdResource() resource.Resource {
	return &templatePolicyListUrlwhitelistIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListUrlwhitelistIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListUrlwhitelistIdResourceModel struct{
...
func (r *templatePolicyListUrlwhitelistIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListUrlwhitelistIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_urlwhitelist_id"
}

func (d *templatePolicyListUrlwhitelistIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListUrlwhitelistIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListUrlwhitelistIdResourceModel

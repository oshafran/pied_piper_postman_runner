...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTranslationrulesResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTranslationrulesResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTranslationrulesResource{}
)

func NewTemplatePolicyListTranslationrulesResource() resource.Resource {
	return &templatePolicyListTranslationrulesResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTranslationrulesResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTranslationrulesResourceModel struct{
...
func (r *templatePolicyListTranslationrulesResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTranslationrulesResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_translationrules"
}

func (d *templatePolicyListTranslationrulesResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTranslationrulesResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTranslationrulesResourceModel

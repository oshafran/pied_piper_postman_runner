...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionFxoportResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionFxoportResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionFxoportResource{}
)

func NewTemplatePolicyDefinitionFxoportResource() resource.Resource {
	return &templatePolicyDefinitionFxoportResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionFxoportResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionFxoportResourceModel struct{
...
func (r *templatePolicyDefinitionFxoportResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionFxoportResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_fxoport"
}

func (d *templatePolicyDefinitionFxoportResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionFxoportResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionFxoportResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListIpprefixallResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListIpprefixallResource{}
	_ resource.ResourceWithImportState = &templatePolicyListIpprefixallResource{}
)

func NewTemplatePolicyListIpprefixallResource() resource.Resource {
	return &templatePolicyListIpprefixallResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListIpprefixallResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListIpprefixallResourceModel struct{
...
func (r *templatePolicyListIpprefixallResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListIpprefixallResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_ipprefixall"
}

func (d *templatePolicyListIpprefixallResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListIpprefixallResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListIpprefixallResourceModel

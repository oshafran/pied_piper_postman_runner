...
type segmentResourceModel struct{
  ...
  SegmentName              types.String           `tfsdk:"segmentName"`
  SegmentId              types.String           `tfsdk:"segmentId"`
}
...
func (d *segmentResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_segment"
}

func (d *segmentResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *segmentResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
  ...
  SegmentName:              types.String{Value: vpnSiteList["key"].(string)}, 
  SegmentId:              types.String{Value: vpnSiteList["key"].(string)}, 
}

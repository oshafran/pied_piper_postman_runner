...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTranslationprofileResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTranslationprofileResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTranslationprofileResource{}
)

func NewTemplatePolicyListTranslationprofileResource() resource.Resource {
	return &templatePolicyListTranslationprofileResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTranslationprofileResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTranslationprofileResourceModel struct{
...
func (r *templatePolicyListTranslationprofileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTranslationprofileResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_translationprofile"
}

func (d *templatePolicyListTranslationprofileResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTranslationprofileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTranslationprofileResourceModel

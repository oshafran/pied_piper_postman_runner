...
var token string;
var (
	_ resource.Resource                = &templatePolicyListClassResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListClassResource{}
	_ resource.ResourceWithImportState = &templatePolicyListClassResource{}
)

func NewTemplatePolicyListClassResource() resource.Resource {
	return &templatePolicyListClassResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListClassResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListClassResourceModel struct{
...
func (r *templatePolicyListClassResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListClassResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_class"
}

func (d *templatePolicyListClassResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListClassResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListClassResourceModel

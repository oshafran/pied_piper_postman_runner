...
var token string;
var (
	_ resource.Resource                = &templatePolicyListLocaldomainIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListLocaldomainIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListLocaldomainIdResource{}
)

func NewTemplatePolicyListLocaldomainIdResource() resource.Resource {
	return &templatePolicyListLocaldomainIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListLocaldomainIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListLocaldomainIdResourceModel struct{
...
func (r *templatePolicyListLocaldomainIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListLocaldomainIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_localdomain_id"
}

func (d *templatePolicyListLocaldomainIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListLocaldomainIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListLocaldomainIdResourceModel

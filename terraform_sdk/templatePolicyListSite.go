...
var token string;
var (
	_ resource.Resource                = &templatePolicyListSiteResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListSiteResource{}
	_ resource.ResourceWithImportState = &templatePolicyListSiteResource{}
)

func NewTemplatePolicyListSiteResource() resource.Resource {
	return &templatePolicyListSiteResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListSiteResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListSiteResourceModel struct{
...
func (r *templatePolicyListSiteResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListSiteResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_site"
}

func (d *templatePolicyListSiteResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListSiteResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListSiteResourceModel

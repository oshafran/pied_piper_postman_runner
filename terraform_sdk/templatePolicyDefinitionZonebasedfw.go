...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionZonebasedfwResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionZonebasedfwResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionZonebasedfwResource{}
)

func NewTemplatePolicyDefinitionZonebasedfwResource() resource.Resource {
	return &templatePolicyDefinitionZonebasedfwResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionZonebasedfwResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionZonebasedfwResourceModel struct{
...
func (r *templatePolicyDefinitionZonebasedfwResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionZonebasedfwResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_zonebasedfw"
}

func (d *templatePolicyDefinitionZonebasedfwResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionZonebasedfwResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionZonebasedfwResourceModel

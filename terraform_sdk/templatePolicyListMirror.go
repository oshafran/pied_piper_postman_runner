...
var token string;
var (
	_ resource.Resource                = &templatePolicyListMirrorResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListMirrorResource{}
	_ resource.ResourceWithImportState = &templatePolicyListMirrorResource{}
)

func NewTemplatePolicyListMirrorResource() resource.Resource {
	return &templatePolicyListMirrorResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListMirrorResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListMirrorResourceModel struct{
...
func (r *templatePolicyListMirrorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListMirrorResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_mirror"
}

func (d *templatePolicyListMirrorResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListMirrorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListMirrorResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionFxsportIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionFxsportIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionFxsportIdResource{}
)

func NewTemplatePolicyDefinitionFxsportIdResource() resource.Resource {
	return &templatePolicyDefinitionFxsportIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionFxsportIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionFxsportIdResourceModel struct{
...
func (r *templatePolicyDefinitionFxsportIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionFxsportIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_fxsport_id"
}

func (d *templatePolicyDefinitionFxsportIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionFxsportIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionFxsportIdResourceModel

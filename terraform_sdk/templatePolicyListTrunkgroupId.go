...
var token string;
var (
	_ resource.Resource                = &templatePolicyListTrunkgroupIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListTrunkgroupIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListTrunkgroupIdResource{}
)

func NewTemplatePolicyListTrunkgroupIdResource() resource.Resource {
	return &templatePolicyListTrunkgroupIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListTrunkgroupIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListTrunkgroupIdResourceModel struct{
...
func (r *templatePolicyListTrunkgroupIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListTrunkgroupIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_trunkgroup_id"
}

func (d *templatePolicyListTrunkgroupIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListTrunkgroupIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListTrunkgroupIdResourceModel

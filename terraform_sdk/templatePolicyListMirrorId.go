...
var token string;
var (
	_ resource.Resource                = &templatePolicyListMirrorIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListMirrorIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListMirrorIdResource{}
)

func NewTemplatePolicyListMirrorIdResource() resource.Resource {
	return &templatePolicyListMirrorIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListMirrorIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListMirrorIdResourceModel struct{
...
func (r *templatePolicyListMirrorIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListMirrorIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_mirror_id"
}

func (d *templatePolicyListMirrorIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListMirrorIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListMirrorIdResourceModel

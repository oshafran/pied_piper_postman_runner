...
var token string;
var (
	_ resource.Resource                = &templatePolicyListRegionIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListRegionIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListRegionIdResource{}
)

func NewTemplatePolicyListRegionIdResource() resource.Resource {
	return &templatePolicyListRegionIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListRegionIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListRegionIdResourceModel struct{
...
func (r *templatePolicyListRegionIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListRegionIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_region_id"
}

func (d *templatePolicyListRegionIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListRegionIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListRegionIdResourceModel

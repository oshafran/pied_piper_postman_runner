...
var token string;
var (
	_ resource.Resource                = &templatePolicyListFqdnResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListFqdnResource{}
	_ resource.ResourceWithImportState = &templatePolicyListFqdnResource{}
)

func NewTemplatePolicyListFqdnResource() resource.Resource {
	return &templatePolicyListFqdnResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListFqdnResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListFqdnResourceModel struct{
...
func (r *templatePolicyListFqdnResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListFqdnResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_fqdn"
}

func (d *templatePolicyListFqdnResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListFqdnResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListFqdnResourceModel

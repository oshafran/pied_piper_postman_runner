...
var token string;
var (
	_ resource.Resource                = &templatePolicyListVpnResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListVpnResource{}
	_ resource.ResourceWithImportState = &templatePolicyListVpnResource{}
)

func NewTemplatePolicyListVpnResource() resource.Resource {
	return &templatePolicyListVpnResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListVpnResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListVpnResourceModel struct{
...
func (r *templatePolicyListVpnResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListVpnResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_vpn"
}

func (d *templatePolicyListVpnResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListVpnResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListVpnResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListDataprefixIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListDataprefixIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListDataprefixIdResource{}
)

func NewTemplatePolicyListDataprefixIdResource() resource.Resource {
	return &templatePolicyListDataprefixIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListDataprefixIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListDataprefixIdResourceModel struct{
...
func (r *templatePolicyListDataprefixIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListDataprefixIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_dataprefix_id"
}

func (d *templatePolicyListDataprefixIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListDataprefixIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListDataprefixIdResourceModel

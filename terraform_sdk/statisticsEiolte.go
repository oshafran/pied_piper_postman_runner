...
var token string;
var (
	_ resource.Resource                = &statisticsEiolteResource{}
	_ resource.ResourceWithConfigure   = &statisticsEiolteResource{}
	_ resource.ResourceWithImportState = &statisticsEiolteResource{}
)

func NewStatisticsEiolteResource() resource.Resource {
	return &statisticsEiolteResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsEiolteResource struct {
	client *sdwanAPI.APIClient
}
type statisticsEiolteResourceModel struct{
...
func (r *statisticsEiolteResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsEiolteResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_eiolte"
}

func (d *statisticsEiolteResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsEiolteResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsEiolteResourceModel

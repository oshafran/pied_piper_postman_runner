...
var token string;
var (
	_ resource.Resource                = &templatePolicyListPortResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListPortResource{}
	_ resource.ResourceWithImportState = &templatePolicyListPortResource{}
)

func NewTemplatePolicyListPortResource() resource.Resource {
	return &templatePolicyListPortResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListPortResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListPortResourceModel struct{
...
func (r *templatePolicyListPortResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListPortResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_port"
}

func (d *templatePolicyListPortResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListPortResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListPortResourceModel

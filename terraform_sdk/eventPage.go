...
var token string;
var (
	_ resource.Resource                = &eventPageResource{}
	_ resource.ResourceWithConfigure   = &eventPageResource{}
	_ resource.ResourceWithImportState = &eventPageResource{}
)

func NewEventPageResource() resource.Resource {
	return &eventPageResource{}
}

// vpnSiteListsResource is the data source implementation.
type eventPageResource struct {
	client *sdwanAPI.APIClient
}
type eventPageResourceModel struct{
...
func (r *eventPageResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *eventPageResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_event_page"
}

func (d *eventPageResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *eventPageResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state eventPageResourceModel

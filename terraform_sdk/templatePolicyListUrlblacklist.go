...
var token string;
var (
	_ resource.Resource                = &templatePolicyListUrlblacklistResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListUrlblacklistResource{}
	_ resource.ResourceWithImportState = &templatePolicyListUrlblacklistResource{}
)

func NewTemplatePolicyListUrlblacklistResource() resource.Resource {
	return &templatePolicyListUrlblacklistResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListUrlblacklistResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListUrlblacklistResourceModel struct{
...
func (r *templatePolicyListUrlblacklistResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListUrlblacklistResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_urlblacklist"
}

func (d *templatePolicyListUrlblacklistResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListUrlblacklistResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListUrlblacklistResourceModel

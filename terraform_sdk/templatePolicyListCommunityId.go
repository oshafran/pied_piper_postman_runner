...
var token string;
var (
	_ resource.Resource                = &templatePolicyListCommunityIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListCommunityIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyListCommunityIdResource{}
)

func NewTemplatePolicyListCommunityIdResource() resource.Resource {
	return &templatePolicyListCommunityIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListCommunityIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListCommunityIdResourceModel struct{
...
func (r *templatePolicyListCommunityIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListCommunityIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_community_id"
}

func (d *templatePolicyListCommunityIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListCommunityIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListCommunityIdResourceModel

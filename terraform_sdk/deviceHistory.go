...
var token string;
var (
	_ resource.Resource                = &deviceHistoryResource{}
	_ resource.ResourceWithConfigure   = &deviceHistoryResource{}
	_ resource.ResourceWithImportState = &deviceHistoryResource{}
)

func NewDeviceHistoryResource() resource.Resource {
	return &deviceHistoryResource{}
}

// vpnSiteListsResource is the data source implementation.
type deviceHistoryResource struct {
	client *sdwanAPI.APIClient
}
type deviceHistoryResourceModel struct{
...
func (r *deviceHistoryResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *deviceHistoryResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_device_history"
}

func (d *deviceHistoryResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *deviceHistoryResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state deviceHistoryResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyDefinitionRulesetIdResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyDefinitionRulesetIdResource{}
	_ resource.ResourceWithImportState = &templatePolicyDefinitionRulesetIdResource{}
)

func NewTemplatePolicyDefinitionRulesetIdResource() resource.Resource {
	return &templatePolicyDefinitionRulesetIdResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyDefinitionRulesetIdResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyDefinitionRulesetIdResourceModel struct{
...
func (r *templatePolicyDefinitionRulesetIdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyDefinitionRulesetIdResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_definition_ruleset_id"
}

func (d *templatePolicyDefinitionRulesetIdResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyDefinitionRulesetIdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyDefinitionRulesetIdResourceModel

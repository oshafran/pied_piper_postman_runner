...
var token string;
var (
	_ resource.Resource                = &statisticsUmbrellaResource{}
	_ resource.ResourceWithConfigure   = &statisticsUmbrellaResource{}
	_ resource.ResourceWithImportState = &statisticsUmbrellaResource{}
)

func NewStatisticsUmbrellaResource() resource.Resource {
	return &statisticsUmbrellaResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsUmbrellaResource struct {
	client *sdwanAPI.APIClient
}
type statisticsUmbrellaResourceModel struct{
...
func (r *statisticsUmbrellaResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsUmbrellaResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_umbrella"
}

func (d *statisticsUmbrellaResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsUmbrellaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsUmbrellaResourceModel

...
var token string;
var (
	_ resource.Resource                = &templatePolicyListProtocolnameResource{}
	_ resource.ResourceWithConfigure   = &templatePolicyListProtocolnameResource{}
	_ resource.ResourceWithImportState = &templatePolicyListProtocolnameResource{}
)

func NewTemplatePolicyListProtocolnameResource() resource.Resource {
	return &templatePolicyListProtocolnameResource{}
}

// vpnSiteListsResource is the data source implementation.
type templatePolicyListProtocolnameResource struct {
	client *sdwanAPI.APIClient
}
type templatePolicyListProtocolnameResourceModel struct{
...
func (r *templatePolicyListProtocolnameResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *templatePolicyListProtocolnameResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_template_policy_list_protocolname"
}

func (d *templatePolicyListProtocolnameResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *templatePolicyListProtocolnameResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state templatePolicyListProtocolnameResourceModel

...
var token string;
var (
	_ resource.Resource                = &statisticsUrlfResource{}
	_ resource.ResourceWithConfigure   = &statisticsUrlfResource{}
	_ resource.ResourceWithImportState = &statisticsUrlfResource{}
)

func NewStatisticsUrlfResource() resource.Resource {
	return &statisticsUrlfResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsUrlfResource struct {
	client *sdwanAPI.APIClient
}
type statisticsUrlfResourceModel struct{
...
func (r *statisticsUrlfResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsUrlfResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_urlf"
}

func (d *statisticsUrlfResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsUrlfResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsUrlfResourceModel

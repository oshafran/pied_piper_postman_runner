...
var token string;
var (
	_ resource.Resource                = &statisticsSystemStatsResource{}
	_ resource.ResourceWithConfigure   = &statisticsSystemStatsResource{}
	_ resource.ResourceWithImportState = &statisticsSystemStatsResource{}
)

func NewStatisticsSystemStatsResource() resource.Resource {
	return &statisticsSystemStatsResource{}
}

// vpnSiteListsResource is the data source implementation.
type statisticsSystemStatsResource struct {
	client *sdwanAPI.APIClient
}
type statisticsSystemStatsResourceModel struct{
...
func (r *statisticsSystemStatsResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	// Retrieve import ID and save to id attribute
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

// Metadata returns the data source type name.
func (d *statisticsSystemStatsResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statistics_system_stats"
}

func (d *statisticsSystemStatsResource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *statisticsSystemStatsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state statisticsSystemStatsResourceModel
